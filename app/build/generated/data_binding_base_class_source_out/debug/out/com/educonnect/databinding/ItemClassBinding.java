...
public final class ItemClassBinding implements ViewBinding {
  ...
  private ItemClassBinding(@NonNull CardView rootView, @NonNull CardView cardView,
      @NonNull TextView tvClassDescription, @NonNull TextView tvClassName) {
    this.rootView = rootView;
    this.cardView = cardView;
    this.tvClassDescription = tvClassDescription;
  ...
  public static ItemClassBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvClassDescription;
      TextView tvClassDescription = ViewBindings.findChildViewById(rootView, id);
      if (tvClassDescription == null) {
        break missingId;
      }
      ...
      return new ItemClassBinding((CardView) rootView, cardView, tvClassDescription, tvClassName);
    }
